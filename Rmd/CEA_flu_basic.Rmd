...
print(c(QALYloss_per_case   = QALYloss_per_case,
        program_QALYloss    = program_QALYloss,
        comparator_QALYloss = comparator_QALYloss))
...
# Display the results
discounted_data = data.frame(Year             = years,
                             Costs            = costs,
...
# print
print(c(life_expectancy_disc     = life_expectancy_disc,
        program_QALYloss_disc    = program_QALYloss_disc,
        comparator_QALYloss_disc = comparator_QALYloss_disc,
...
`r if (!show_results) {
    '<a href="CEA_flu_basic_results.html"> Results</a>'
  } else {
    '<a href="CEA_flu_basic.html"> Back</a>'
  }
`
</div>
