...
5. **The Role of Uncertainty:** Reflect on the decision when the cost per case is represented by `rgamma(100, shape=(122/70)^2, rate = 122/70^2))` and the vaccine efficacy by `rnorm(100,vaccine_efficacy,0.1)`. Try to reproduce the figure below for 100 samples:
