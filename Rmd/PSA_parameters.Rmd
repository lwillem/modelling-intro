...
Define the uncertainty distributions of the following parameters of our flu model:

* Force of Infection: 4% (n=100)
* Proportion hospitalised: 10% (n=100)
* Hospital case fatality ratio: 30% (n=1000)
...
hosp_case_fatality_ratio_norm = rnorm(nsamples,0.3, sqrt(0.3 * (1 - 0.3) / 1000)) 
...
hosp_case_fatality_ratio_beta = sample_beta_event(nsamples, 300, 1000)
...
plot(density(force_of_infection_norm), 
     main = 'force of infection', 
     ylim = c(0,25))
lines(density(force_of_infection_beta), 
      col = 2)
abline(v = mean(force_of_infection_norm),
       lty = 2)
grid()
legend('topright',
      c('Norm()','Beta()', 'mean'),
...
plot(density(p_hospital_norm), 
     main = 'probability of hospitalisation', 
     ylim = c(0, 25))
lines(density(p_hospital_beta),
      col = 2)
abline(v = mean(p_hospital_norm),
       lty = 2)
grid()
legend('topright',
      c('Norm()','Beta()', 'mean'),
...
plot(density(hosp_case_fatality_ratio_norm), 
     main = 'hospital case fatality ratio')
lines(density(hosp_case_fatality_ratio_beta),
      col = 2)
abline(v = mean(hosp_case_fatality_ratio_norm),
       lty = 2)
grid()
legend('topright',
      c('Norm()','Beta()', 'mean'),
...
plot(density(life_expectancy_norm), 
     main = 'life expectancy')
lines(density(life_expectancy_gamma),
      col = 2)
abline(v = mean(life_expectancy_norm), 
       lty = 2)
grid()
legend('topright',
      c('Norm()','Gamma()', 'mean'),
...
plot(density(vaccine_efficacy_norm), 
     main = 'vaccine effectiveness')
lines(density(vaccine_efficacy_lognormal),
      col = 2)
lines(density(vaccine_efficacy_beta),
      col = 3)
abline(v = mean(vaccine_efficacy_norm),
       lty = 2)
grid()
legend('topright',
...
plot(density(adm_cost_norm), 
     main = 'administration cost')
lines(density(adm_cost_gamma),
      col = 2)
abline(v = mean(adm_cost_norm),
       lty = 2)
grid()
legend('topright',
      c('Norm()','Gamma()', 'mean'),
...
plot(density(cost_hosp_norm), 
     main = 'cost per hospital case')
lines(density(cost_hosp_gamma),
      col = 2)
abline(v = mean(cost_hosp_norm),
       lty = 2)
grid()
legend('topright',
      c('Norm()','Gamma()', 'mean'),
...
plot(density(cost_non_hosp_norm), 
     main = 'cost per non-hospital case')
lines(density(cost_non_hosp_gamma),
      col = 2)
abline(v = mean(cost_non_hosp_norm), 
       lty = 2)
grid()
legend('topright',
      c('Norm()','Gamma()', 'mean'),
...
plot(density(QALYloss_hosp_case_norm), 
     main = 'QALY loss per hospital case')
lines(density(QALYloss_hosp_case_beta),
      col = 2)
abline(v = mean(QALYloss_hosp_case_norm),
       lty = 2)
grid()
legend('topright',
      c('Norm()','Beta()', 'mean'),
...
plot(density(QALYloss_non_hosp_case_norm), 
     main = 'QALY loss per non-hospital case')
lines(density(QALYloss_non_hosp_case_beta),
      col = 2)
abline(v = mean(QALYloss_non_hosp_case_norm),
       lty = 2)
grid()
legend('topright',
      c('Norm()','Beta()', 'mean'),
...
```{r, echo = !show_results}
# over to you... define and visualise the uncertainty distributions of the parameters of our flu model.
```

```{r, echo = show_results}

 
# * force of infection: sample size rather small for Normal distribution, use Beta (= strict positive!)
...
# * QALY loss per non-hospital case: absolute values rather small for normal distribution, use Beta
```
...
`r if (!show_results) {
    '<a href="PSA_parameters_results.html"> Results</a>'
  } else {
    '<a href="PSA_parameters.html"> Back</a>'
  }
`
