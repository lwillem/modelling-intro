...
plot(density(hosp_case_fatality_ratio_norm), main = 'hospital case fatality ratio')
lines(density(hosp_case_fatality_ratio_beta),col = 2)
abline(v = mean(hosp_case_fatality_ratio_norm), lty = 2)
grid()
legend('topright',
      c('Norm()','Beta()', 'mean'),
      col = c(1,2,1),
