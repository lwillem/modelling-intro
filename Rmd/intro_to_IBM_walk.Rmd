...
(TIP: the `run_ibm_random_walk` function has an option to `add_baseline_prevalence = TRUE` to add the prevalence with the default parameters. However, this increases the run time since the model is executed twice.)
