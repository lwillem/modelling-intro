---
title: "HTA flu CEA with uncertainty"
toc: no
---
...
hist(incr_total_cost / infections_averted, xlab = 'Incremental total cost per infection averted', main = 'Histogram of Incremental Cost per Infection Averted')
...
```{r}
mean(incr_total_cost/infections_averted)       # mean of ratios
median(incr_total_cost/infections_averted)     # median of ratios
mean(incr_total_cost)/mean(infections_averted) # ratio of means: ICER!!
```
