...
hist(incr_total_cost / QALY_gained_disc, xlab = 'point-wise incremental total cost per infection averted', main = 'Histogram of Pointwise Incremental Cost per Infection Averted')
...
# net-loss: difference between expected INMB and INMB with perfect information by sample
...
plot(x = inmb_wtp_summary$wtp,
     ...
     main = 'Cost-Effectiveness Acceptibility Curve',
     ylim = 0:1)
...
plot(x = inmb_wtp_summary$wtp,
     ...
     main = 'Cost-Effectiveness Acceptibility Frontier',
     ylim = 0:1)
...
plot(x = inmb_wtp_summary$wtp,
     ...
     xlab = 'Willingness To Pay',
     ylab = 'Probability to be cost-effective',
     main = 'Cost-Effectiveness Acceptibility',
     ylim = 0:1)
