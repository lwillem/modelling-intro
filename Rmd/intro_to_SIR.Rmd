...
legend(23, 80000, c("Susceptibles", "Infecteds", "Recovereds"), lwd = 3, lty = 1, col =c("green","red","blue")) # Add legend and specific position
```
...
lines(out[,"time"],out[,"I"],col="red",lwd = 5)
lines(out[,"time"],out[,"R"],col="blue",lwd = 5)
legend(23, 80000, c("Susceptibles", "Infecteds", "Recovereds"), lwd = 3, lty = 1, col = c("green","red","blue")) #
