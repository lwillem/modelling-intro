...
For this practical, you will first need to download the required data from (in [CSV format](https://en.wikipedia.org/wiki/Comma-separated_values)) from [here](https://github.com/lwillem/modelling-intro/raw/master/data/data.csv). Save it in the correct folder and make this your current working directory. 
...
# Navigate
Top: [Index](index.html) Next: [Introduction to infectious disease modelling in R](intro_to_SIR_lw.html)
</div>
