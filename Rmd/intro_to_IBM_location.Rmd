...
The individual-based model will make use of a virtual population in wich each individual is part of a household, school/work (based on age), and the general community. Each day (= time step), indiviuals can interact at home, school/work and in the community. We specify for each location a contact probability or average number of contacts per day.
...
* increase the average number of community contacts?
* increase the contact probability at schools?
* increase the contact probability at workplaces?
* ... etc.
