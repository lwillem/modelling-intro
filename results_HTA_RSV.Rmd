...
* With the dynamic model, we observed an inverse relationship between the ICER and vaccine uptake. The more vaccines are administered, the incremental benefit decreases. The overall QALY gain, off-course, direct related with vaccine uptake.
